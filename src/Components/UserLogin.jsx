  ...
  return (
    <section className='h-screen'>
      <div className="grid grid-cols-1 lg:grid-cols-2 lg:h-screen lg:py-7 lg:px-6">
        <div className="relative flex items-end px-4 pb-10 pt-16 sm:px-6 sm:pb-16 md:justify-center lg:px-8 lg:pb-24 lg:pt-20">
        ...
        <div className="flex items-center justify-center px-4 py-10 sm:px-6 sm:py-16 lg:px-8 lg:py-24">
          <div className="xl:mx-auto xl:w-full xl:max-w-sm 2xl:max-w-md">
            <h2 className="text-3xl font-bold leading-tight text-black sm:text-4xl">User Login</h2>
